        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-12">
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/naveentak/rclip-macos-app" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
          ...
          >
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="https://github.com/naveentak/rclip-macos-app/releases" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors">Release Notes</a></li>
